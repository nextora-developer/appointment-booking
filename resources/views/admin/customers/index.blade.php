...
@section('content')
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <form method="GET" action="{{ route('admin.customers.index') }}" class="relative w-full lg:max-w-sm">
                        ...
                        <div class="flex items-start justify-between gap-3">
                            <div class="min-w-0">
                                ...
                                <p class="mt-1 text-[11px] text-slate-400 flex items-center gap-1">
                                    <i data-lucide="badge-check" class="w-3 h-3 shrink-0"></i>
                                    Customer ID: {{ $customer->id }}
                                </p>
                            </div>

                            <span
                                class="inline-flex items-center gap-1.5 rounded-lg border border-indigo-100 bg-indigo-50 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-indigo-700 whitespace-nowrap">
                                {{ $customer->appointments_count }} bookings
                            </span>
                        </div>
